...
![lab-icon](https://raw.githubusercontent.com/ngHeroes/todo-list-tutorial/master/assets/lab.jpg) **Playground:** Change the method `changeTitle` so it will receive the whole element reference and log it to the console:
