...
### Explore the $event
 ...
 ![lab-icon](https://raw.githubusercontent.com/ngHeroes/todo-list-tutorial/master/assets/lab.jpg)**Playground:** You can change the changeTitle method to log the `$event` object in the console. This way you can explore it and see what properties it has.
